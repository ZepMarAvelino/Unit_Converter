#ifndef LENGTH_TYPE_H
#define LENGTH_TYPE_H
...
/**
 * @brief Length_Type Struct - Defines all units, prefixes, and measurement systems used by the Length class
 */
struct Length_Type{
    ...
    #define METRIC_TYPES Metre, Fermi, Angstrom, Micron, Myriametre, X_Unit
    #define IMPERIAL_TYPES Point, Pica, Thou, Inch, Foot, Yard, Chain, Furlong, Mile, League, Fathom, Short_Cable, Long_Cable, Nautical_Mile
    #define US_TYPES Link, Survey_Inch, Survey_Foot, Rod, Survey_Chain, Survey_Furlong, Survey_Mile, Survey_League

    /**
     * @brief Enum Class that holds the measurement systems available for the Length_Type
     */
    enum class System {UNIT_SYSTEM_BASE_VALUES};

    /**
     * @brief Enum Class that holds the unit types available for the Length_Type
     */
    enum class Type {UNIT_TYPE_BASE_VALUES, METRIC_TYPES, IMPERIAL_TYPES, US_TYPES};
    
    /**
     * @brief Enum Class that holds the prefixes available for the Length_Type
     */
